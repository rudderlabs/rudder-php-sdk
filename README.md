...
| `max_retry_delay`       | Number   | `10000`                         | Maximum retry backoff delay in milliseconds.                                                                                                                                                                                                                |
| `retry_jitter_ratio`    | Number   | `0.2`                           | Jitter ratio added to retry delays.                                                                                                                                                                                                                         |
| `respect_retry_after`   | Boolean  | `true`                          | Whether to honor the `Retry-After` response header for retryable responses.                                                                                                                                                                                 |
